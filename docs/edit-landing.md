...
???+ 敬请留意
    ...
    - 现在您的更改将会视 Commit Message 质量以 Rebase 或 Squash 方式之一合并，且在 Squash 方式下您可能会是该 commit 的 author 而不是 committer，敬请留意。
...
<script>
	...
	document.getElementById("btn-startedit").href = "https://github.com/AFOI-wiki/afoi-wiki/edit/master/docs" + getQueryVariable("ref", "");
</script>
